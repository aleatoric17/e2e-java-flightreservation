package com.young.flightreservation.dto;
...
public class ReservationRequest {
	...
	public String getExpireationDate() {
		return expireationDate;
	}

	public void setExpireationDate(String expireationDate) {
		this.expireationDate = expireationDate;
	}
	...
	public String toString() {
		return "ReservationRequest [flightId=" + flightId + ", passengerFirstName=" + passengerFirstName
				...
				+ cardNumber + ", expireationDate=" + expireationDate + ", securityCode=" + securityCode + "]";
	}
